  ...
  <form action="/action_page.php">
    ...
    <div class="row">
     ...
     <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="uname" name="lastname" placeholder="Your username..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="pwd" name="lastname" placeholder="Your password..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="cpwd" name="lastname" placeholder="Confirm password..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
