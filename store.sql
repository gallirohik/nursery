...
INSERT INTO `products` (`pid`, `pname`, `img1`, `img2`, `img3`, `sid`, `price`, `ratings`, `description`, `category`) VALUES
('01', 'rose', 'images/img1.jpeg', '', '', '1', 50, 0, '', ''),
('02', 'lilly', 'images/img2.jpeg', '', '', '1', 40, 0, '', ''),
('03', 'plant1', 'images/img3.jpeg', '', '', '1', 50, 5, '', ''),
('04', 'plant2', 'images/img4.jpeg', '', '', '1', 56, 7, '', ''),
('05', 'plant4', 'images/img5.jpeg', '', '', '1', 45, 8, '', '');
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`sid`) REFERENCES `sellers` (`sid`);
